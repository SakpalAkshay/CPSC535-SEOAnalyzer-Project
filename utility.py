...
def keyWordsDensityFind(df,filtered_words):
    totalWords = filtered_words
    df['Keyword Density'] = (df['Word Count'] / totalWords) * 100

    # Create a new DataFrame with only 'Word' and 'Keyword Density' columns
    result_df = df[['Word', 'Keyword Density']]
    return result_df
